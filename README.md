# NOTE:
This shit is just proof of my boredom in my spare time I doubt there are more versions in the future, I will finish implementing all the reinx services on the fork of the atmosphere modules.
...
```
git clone --recurse-submodules https://github.com/Reisyukaku/R3iNX.git
cd R3iNX && make
```
...
* Loads all KIPs from `/R3iNX/sysmodules/` directory
...
* Exclusive R3iNX sysmodules

* ES patch in RXP patch format (used with custom loader.kip)

**Official thread:**

[HERE](https://gbatemp.net/threads/official-R3iNX-thread.512203/)

**Official Installation guide**

[HERE](https://R3iNX.guide/)
